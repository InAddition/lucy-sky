...
<div class="wrapper wrapper-full-width">
	<?php if( have_rows('header_content_full_width_content', 236) ): ?>
		<?php while( have_rows('header_content_full_width_content', 236) ): the_row(); ?>
				<?php
					// vars
	...
	<div class="page-content">
		...
		<?php if( have_rows('footer_content_full_width_content', 236) ): ?>
			<?php while( have_rows('footer_content_full_width_content', 236) ): the_row(); ?>
					<?php
						// vars
						$header = get_row_layout() == 'header';
						$feature_slider = get_row_layout() == 'feature_slider';
